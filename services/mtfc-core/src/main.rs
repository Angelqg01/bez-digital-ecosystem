...
async fn main() {
    println!("=================================================================");
    println!("   M-TFC ENGINE: PRUEBA DE ESTRES ESTOCASTICO EN RUST v1.2       ");
    println!("=================================================================\n");
    ...
    let colapsos_totales = stream::iter(0..num_operaciones)
        .map(|i| {
            task::spawn(async move {
                ...
                evaluar_lona_unificada(1.0, tension_est, tension_din, 1e-6)
            })
        })
    ...
    println!("=================================================================");
    println!("              INFORME DE RENDIMIENTO BAJO CAOS TERMICO           ");
    println!("=================================================================");
    println!(" Tiempo de procesamiento nativo:    {:?}", duracion);
    println!(
        " Rendimiento bruto del motor:       {:.2} operaciones/seg",
        num_operaciones as f64 / duracion.as_secs_f64()
    );
    println!(" Transiciones criticas mitigadas:   {}", colapsos_totales);
