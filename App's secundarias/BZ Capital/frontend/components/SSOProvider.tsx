...
function SSOHandler({ setToken, setUser, setIsLoading, setModalOpen }: { setToken: any, setUser: any, setIsLoading: any, setModalOpen: any }) {
  ...
  useEffect(() => {
    ...
    if (urlToken) {
      console.log('🔑 SSO Token detected in URL. Storing to localStorage...');
    ...
    setIsLoading(false);
  }, [searchParams, router, pathname, setToken, setUser, setIsLoading]);
