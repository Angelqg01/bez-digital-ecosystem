...
async function main() {
    ...
    console.log("   Tx Hash:", offers.deployTransaction.hash);
    await offers.deployed();
    console.log("✅ NFTOffers Address:", offers.address);

    // ========================================================
    // 2. DEPLOY NFT RENTAL
    // ========================================================
    console.log("\n📦 Desplegando NFTRental...");
    ...
    // Constructor requires: (address _paymentToken, address _feeRecipient)
    const rental = await RentalFactory.deploy(PAYMENT_TOKEN, wallet.address, overrides);
