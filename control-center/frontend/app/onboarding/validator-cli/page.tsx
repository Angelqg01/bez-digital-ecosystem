...
export default function ValidatorCliPage() {
    ...
    return (
        <div className="min-h-screen bg-[#03060E] text-[#E8F4FF] p-6">
            <div className="max-w-4xl mx-auto space-y-6">
                <header>
                    <p className="text-xs uppercase tracking-wider text-[#3D5E80]">Onboarding avanzado</p>
                    <h1 className="text-2xl font-semibold">Validator CLI (Fase 12B)</h1>
                    <p className="text-[#3D5E80] mt-1">
                        Generador del comando <code>register-validator.js</code>. El registro on-chain se
                        ejecuta desde tu terminal — esta pantalla sólo compone la línea con los datos correctos.
                    </p>
                </header>
                ...
                <section className="border border-[#0D2040] rounded-lg p-4 bg-[#0C1628]">
                    ...
                    <p className="text-[#3D5E80] mt-2 text-sm">
                        Copia/pega este comando en tu terminal (ajustando <code>--privateKey</code> y overrides si faltan direcciones).
                    </p>
