# AGENTS.md — BeZhas Master Context File
> [!IMPORTANT]
...
# Válido para: Codex (terminal) \+ Cowork (desktop) \+ Codex.ai (MCPs)
...
│   │   └── providers/             ← Codex, Gemini, GPT-4o, DeepSeek, LLaMA
...
1\. Codex (Anthropic API)        ← Primario
...
Precio por tarea = (coste Codex + cómputo BeZhas) × 1,25 → 0,1969 € las
...
- [ ] Addresses actualizadas en este AGENTS.md (sección contratos)
