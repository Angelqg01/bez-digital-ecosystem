...
const CLUSTERS = {
  ...
  'ia-conocimiento': {
    ...
    desc: 'Cerebro y orquestación: Aegis (ML), OpenClaw (multi-LLM), agent-lib (8 agentes), Brain Obsidian y base de conocimiento SKILL/.',
  },
  'finanzas-pagos': {
...
const ENTRIES = [
  ...
  { folder: '05-Platform', title: 'Agent-Runtime', cluster: 'ia-conocimiento', priority: 'P0', path: 'agent-lib/ + core/AgentToolRegistry.js', port: null,
  ...
  { folder: '05-Platform', title: 'SDK-BeZhas', cluster: 'nucleo-blockchain', priority: 'P1', path: 'sdk/ + App-nativas/packages/connect', port: null,
  ...
  // SubApps (06-SubApps)
  { folder: '06-SubApps', title: 'Bezhas-Hub', cluster: 'finanzas-pagos', priority: 'P0', path: "App-nativas/Bezhas-Hub/", port: 5173, domain: 'hub.bez.digital',
  ...
  { folder: '06-SubApps', title: 'BeZhas-Pay', cluster: 'finanzas-pagos', priority: 'P0', path: "App-nativas/bezhas-pay-manager/", port: null, domain: 'pay.bez.digital',
  ...
  { folder: '06-SubApps', title: 'BEZ-Wallet', cluster: 'finanzas-pagos', priority: 'P0', path: "App-nativas/bez-wallet/", port: null, domain: 'wallet.bez.digital',
  ...
  { folder: '06-SubApps', title: 'BZ-Capital', cluster: 'finanzas-pagos', priority: 'P1', path: "App-nativas/BZ Capital/", port: null, domain: 'capital.bez.digital (ruta /defi)',
  ...
  { folder: '06-SubApps', title: 'BZ-Gas-Tank', cluster: 'finanzas-pagos', priority: 'P1', path: "App-nativas/gas-tank-manager/", port: null, domain: 'gas.bez.digital',
    desc: 'Paymaster manager: patrocinio de gas B2B, recargas y límites por tenant.',
    links: ['BEZ-Wallet', 'Smart-Contracts'] },
  { folder: '06-SubApps', title: 'BZ-CargoLink', cluster: 'logistica-rwa', priority: 'P1', path: "App-nativas/BZ CargoLink/", port: 3017, domain: 'cargolink.bez.digital',
  ...
  { folder: '06-SubApps', title: 'BZ-PureScan', cluster: 'logistica-rwa', priority: 'P1', path: "App-nativas/BZ PureScan/", port: null, domain: 'purescan.bez.digital',
    desc: 'Trazabilidad y certificación de pureza/calidad con QR verificable on-chain.',
    links: ['BZ-CargoLink', 'BZ-Vision-Scan'] },
  { folder: '06-SubApps', title: 'BZ-Vision-Scan', cluster: 'logistica-rwa', priority: 'P1', path: "App-nativas/bez-vision-scan/", port: null, domain: 'vision.bez.digital',
  ...
  { folder: '06-SubApps', title: 'RWA-Gemelos-Digitales', cluster: 'logistica-rwa', priority: 'P2', path: "App-nativas/RWA gemelos digitales/", port: null, domain: null,
  ...
  { folder: '06-SubApps', title: 'BZ-Energy', cluster: 'energia-iot', priority: 'P1', path: "App-nativas/bez-energy/", port: 3019, domain: 'energy.bez.digital',
  ...
  { folder: '06-SubApps', title: 'BZ-Edge-Manager', cluster: 'infra-devops', priority: 'P1', path: "App-nativas/edge-node-manager/", port: null, domain: 'edge.bez.digital',
    desc: 'Gestión de edge nodes B2B: registro, salud, recompensas (EdgeNodeRewards).',
    links: ['Edge-Node', 'Infraestructura-Docker'] },
  { folder: '06-SubApps', title: 'BZ-Prestige', cluster: 'identidad-comunidad', priority: 'P2', path: "App-nativas/BZ Prestige/", port: null, domain: 'prestige.bez.digital',
    desc: 'Reputación y prestigio empresarial dentro del ecosistema (score verificable).',
    links: ['BeZhas-ID-Nota', 'BZ-Sphere'] },
  { folder: '06-SubApps', title: 'BZ-Sphere', cluster: 'identidad-comunidad', priority: 'P2', path: "App-nativas/BZ Sphere/", port: null, domain: 'sphere.bez.digital',
    desc: 'Red/comunidad del ecosistema de socios pre-verificados.',
    links: ['BZ-Prestige', 'BZ-Genesis'] },
  { folder: '06-SubApps', title: 'BZ-Genesis', cluster: 'identidad-comunidad', priority: 'P2', path: "App-nativas/BZ Genesis/", port: null, domain: 'genesis.bez.digital',
  ...
  { folder: '06-SubApps', title: 'BeZhas-Docs', cluster: 'ia-conocimiento', priority: 'P2', path: "App-nativas/BeZhas-Docs/", port: null, domain: null,
