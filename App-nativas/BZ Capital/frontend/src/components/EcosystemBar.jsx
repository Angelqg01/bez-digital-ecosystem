          ...
          <>
            {service.action === 'BUY' && (
              <div>
                ...
                <input defaultValue="500" style={{ width: '100%', background: '#0e0e0e', border: '1px solid #333', color: '#fff', padding: '12px 16px', fontSize: 18, fontWeight: 800, borderRadius: 10, marginBottom: 12 }} />
                <div style={{ padding: 12, background: '#0a0a0a', borderRadius: 8, fontSize: 11, color: '#888', marginBottom: 16 }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 4 }}><span>Total:</span><span style={{ fontWeight: 800 }}>$74.00 USD</span></div>
                </div>
              </div>
            )}
            {service.action === 'SCAN' && (
            ...
            {service.action === 'SUBSCRIBE' && (
              <div style={{ display: 'grid', gap: 8, marginBottom: 16 }}>
                {[{ name: 'Starter', price: '$9.99/mo', items: ['3 Apps', '100 API calls/day'] }, { name: 'Business', price: '$49.99/mo', items: ['All Apps', '10k API calls/day', 'Webhooks'] }].map(plan => (
                  <div key={plan.name} style={{ padding: 14, background: '#0a0a0a', border: `1px solid ${plan.name === 'Business' ? '#a855f7' : '#333'}`, borderRadius: 10 }}>
            ...
            {service.action === 'VALIDATE' && (
              <div style={{ marginBottom: 16 }}>
                ...
                <input defaultValue="0x8f3a..." style={{ width: '100%', background: '#0e0e0e', border: '1px solid #333', color: '#00f0ff', padding: '12px 16px', fontSize: 14, fontFamily: 'monospace', borderRadius: 10, marginBottom: 12 }} />
              </div>
            )}
            {(service.action === 'REFUEL' || service.action === 'STAKE') && (
              <div style={{ marginBottom: 16 }}>
                ...
                <input defaultValue="100" style={{ width: '100%', background: '#0e0e0e', border: '1px solid #333', color: '#fff', padding: '12px 16px', fontSize: 18, fontWeight: 800, borderRadius: 10, marginBottom: 12 }} />
              </div>
            )}
