...
var telegramMcp_js_1 = require("./src/tools/telegramMcp.js");
function test() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, telegramMcp_js_1.handleTelegramTool)('send_telegram_message', args)];
                case 2:
                    result = _a.sent();
                ...
                case 3:
                    e_1 = _a.sent();
                    console.error("Test failed with exception:", e_1);
                    return [3 /*break*/, 4];
