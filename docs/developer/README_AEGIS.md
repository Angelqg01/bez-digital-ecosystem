...
TELEGRAM\_BOT\_TOKEN=         \# De @BotFather en Telegram

TELEGRAM\_ALERT\_CHAT\_ID=     \# De @userinfobot

TELEGRAM\_AUTHORIZED\_USERS=  \# Tu Telegram user ID

ANTHROPIC\_API\_KEY=          \# De console.anthropic.com
...
OLLAMA\_MAX\_LOADED\_MODELS=2  → Ollama gestiona el swap automáticamente
